...
let () =
  let n = 0 in
  let n = n + check "happy" (confirm (common "H-OPEN-OK")) "Ok BKG-H-OPEN-OK total 21000" in
  let n = n + check "expired" (confirm (common "H-EXPIRED")) "Hold_expired H-EXPIRED 2026-01-01T00:00:00Z" in
  let n = n + check "already" (confirm (common "H-CONFIRMED")) "Hold_already_confirmed BKG-H-CONFIRMED" in
  ...
  let n = n + check "guest-self" (confirm (cmd "H-OPEN-OK" "pay_ok" "2026-11-01T10:00:00Z" "guest-self")) "Ok BKG-H-OPEN-OK total 21000" in
